// import { extractText, validateMessage, getDate } from "../../../config/utils";
// import { database } from "../../twilio";
// import { barbersInShop, getBarberAppointments } from "../../db";
...
//     try {
//       barber = await (database.findBarberInDatabase(
//         barberName
//       ) as Promise<BARBER>);
//     } catch (err) {
//       next(err);
...
//     if (!validatedResponse)
//       return sendTextMessage(
//         this.UserMessage.errorValidatingConfirmingAppointment
//       );
